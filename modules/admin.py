...
def admin_form(root, panel_left, panel_right):
    ...
    main_menu_button2 = tk.Button(main_menu_frame, text=f"Manage \n pharmacist", font=("Open Sans ExtraBold", 25),width=root.winfo_screenwidth() // 93, fg="#061e41", bg="#ffffff",activeforeground="#ffffff", activebackground="#061e41", highlightthickness=0, bd=0)
